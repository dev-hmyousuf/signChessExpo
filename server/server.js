...
// For deployment: Allow configuring the host with environment variable
// This will be the public URL where your server is hosted
const HOST = process.env.HOST || process.env.PUBLIC_URL || `http://${localIp}:${PORT}`;
